...
public class ConfirmOrderTest extends ManagementBaseTest {
    ...
    @Test(description = "Kiểm thử admin xác nhận đơn hàng đang ở trạng thái chờ xác nhận")
    @AllureId("Admin-05")
    @Epic("Chức năng Quản lý đơn hàng")
    @Feature("Xác nhận đơn hàng")
    @Story("Admin xác nhận đơn hàng đang ở trạng thái chờ xác nhận")
    ...
    public void confirmOrder() throws InterruptedException {
        ...
        String confirmedOrderId = managementPage.confirmFirstPendingOrder();
        //managementPage.confirmFirstPendingOrder();
        ...
        profilePage.clickOrderTabByIndex(3);
        Thread.sleep(1000);
        // Kiểm tra đơn hàng có tồn tại
        boolean isFound = profilePage.isOrderIdVisibleInTab("Đã xác nhận", confirmedOrderId);
